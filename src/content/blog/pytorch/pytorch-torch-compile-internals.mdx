...
> 本文是 [torch.compile 到底优化了什么？从 Benchmark 看算子融合的本质](/blog/pytorch/pytorch-torch-compile-fusion) 的续篇，建议先阅读上篇了解算子融合的基本概念。
...
这种优化需要人理解“softmax 可以用 online 算法分块计算”，不是编译器能自动推导的代码变换。
